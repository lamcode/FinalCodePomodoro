        ...
        return(
            <section>
                ...
                <section className="timer-actions">
                    ...
                    <button disabled={this.props.isPlay === true ? "disabled" : ""} onClick={this.stopTimer}>Stop</button>
                    <button disabled={this.props.isPlay === true ? "disabled" : ""} onClick={this.resetTimer}>Refresh</button>
                </section>
            </section>
        );
    }
